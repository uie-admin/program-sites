...
export default function Cohort7() {
    return (
        <div id="Cohort7">
            <Navbar />
            <Header />
            <GreenArticle>
                <h1>Join April Cohort</h1>
            </GreenArticle>
            <TestComponent>
            ...
            <TestComponent>
                <div className="">
                    ...
                    <p>
                        <b>
                            As a team, you’ll develop your Outcome-driven UX
                            Metrics together.{" "}
                        </b>
                        You’ll identify the most effective UX metrics to tell
                        your teams’ story. You’ll come away from the course with
                        your own custom approach to UX Metrics that your entire
                        team can use.
                    </p>
                    <p>
                        <b>
            ...
            <SpiffyCheckout>
                <h2>Join the April UX Metrics Cohort</h2>
                <spiffy-checkout url="https://centercentre.spiffy.co/checkout/ux-metrics-cohort-7"></spiffy-checkout>
            </SpiffyCheckout>
