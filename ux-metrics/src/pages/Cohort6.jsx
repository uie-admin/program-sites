...
export default function Cohort6() {
    return (
        <div id="Cohort6">
            ...
            <SpiffyCheckout>
                <h2>Join the March UX Metrics Cohort</h2>
                <spiffy-checkout url="https://centercentre.spiffy.co/checkout/ux-metrics-cohort-6"></spiffy-checkout>
            </SpiffyCheckout>
