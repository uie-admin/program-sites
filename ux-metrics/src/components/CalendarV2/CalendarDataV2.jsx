...
// const TABLE_ID_COHORT# = import.meta.env.E_TABLE_ID_COHORT#;
...
const cohortTables = {
    RESEARCH: {
        ...
        A: import.meta.env.VITE_RESEARCH_TABLE_ID_COHORTA,
        B: import.meta.env.VITE_RESEARCH_TABLE_ID_COHORTB,
        C: import.meta.env.VITE_RESEARCH_TABLE_ID_COHORTC,
    },
    METRICS: {
...
export const fetchCohort = async (tableName, cohortName) => {
    const url = `https://api.airtable.com/v0/${cohortTables[tableName]["ID"]}/${cohortTables[tableName][cohortName]}`;
    const headers = {
