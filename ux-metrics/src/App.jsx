        ...
        <Router>
            <CohortContext.Provider value={cohorts}>
                <UpcomingCohortContext.Provider value={upcomingCohorts}>
                    ...
                    <Header
                        title="Outcome-Drive UX Metrics"
                    ...
                    <Routes>
                        ...
                        <Route key={`cohort`} path={`/Cohort`} element={
                            !upcomingCohorts ?
                                <Cohort cohortIndex={null} cohortName={DEFAULT_COHORT_NAME} />
                                : <Cohort cohortIndex={upcomingCohorts[0][0].cohortNumber} cohortName={COHORT_NAMES[upcomingCohorts[0][0].cohortNumber - 1]} />}
                        />
                        <Route key={`cohort-schedule`} path={`/Cohort-schedule`} element={
                            !upcomingCohorts ?
                                <CohortSchedule cohortIndex={null} cohortName={DEFAULT_COHORT_NAME} />
                                : <CohortSchedule cohortIndex={upcomingCohorts[0][0].cohortNumber} cohortName={COHORT_NAMES[upcomingCohorts[0][0].cohortNumber - 1]} />}
                        />
                            ...
                            return (
                                <>
                                    <Route
                                        ...
                                        element={
                                            <Cohort cohortIndex={cohortIndex} cohortName={COHORT_NAMES[i]} />
                                        }
                                    />
                                    <Route
                                        ...
                                        element={
                                            <CohortSchedule
                                                cohortIndex={cohortIndex} cohortName={COHORT_NAMES[i]}
                                            />
                                        }
                                    />
                                </>
